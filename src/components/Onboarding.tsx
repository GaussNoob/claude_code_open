...
import { ExternalProviderSetup } from './ExternalProviderSetup.js';
import { WelcomeV2 } from './LogoV2/WelcomeV2.js';
import { PressEnterToContinue } from './PressEnterToContinue.js';
import { ThemePicker } from './ThemePicker.js';
import { OrderedList } from './ui/OrderedList.js';
type StepId = 'preflight' | 'theme' | 'oauth' | 'api-key' | 'external-provider' | 'security' | 'terminal-setup';
...
export function Onboarding({
  ...
  const [showExternalProviderSetup, setShowExternalProviderSetup] = useState(false);
  ...
  const handleContinueWithoutLogin = useCallback(() => {
    setShowExternalProviderSetup(true);
    setSkipOAuth(true);
  }, []);
  ...
  if (oauthEnabled) {
    steps.push({
      ...
      component: <SkippableStep skip={skipOAuth} onSkip={goToNextStep}>
          <ConsoleOAuthFlow onDone={goToNextStep} onContinueWithoutLogin={handleContinueWithoutLogin} />
        </SkippableStep>
    });
  }
  if (showExternalProviderSetup) {
    steps.push({
      id: 'external-provider',
      component: <ExternalProviderSetup onDone={goToNextStep} />
    });
  }
  steps.push({
    id: 'security',
